...
public:
    ...
    uint32_t downloadFileBinary(const String filename, uint8_t buf[], uint32_t size, const bool append);
    ...
    uint32_t readFileBinary(const String filename, uint8_t* content);
