...
public:
  ...
  virtual void configHeaders(int headerIndex, const char* header);
  ...
  virtual void postData(const char* path, const char* resultfilename, const char* data);
  virtual void postFile(const char* path, const char* resultfilename, const char* dataFilename);
